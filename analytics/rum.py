...
analytics-events.js (Web Vitals ride on the existing AnalyticsEvent
...
- LCP and INP are measured natively via PerformanceObserver in the
  browser — see analytics-events.js — and match the metrics'
...
- INP here is the single largest interaction duration observed on the
  ...
  documented as a simplification in analytics-events.js. For a typical
