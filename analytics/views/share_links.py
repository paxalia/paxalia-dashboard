# analytics/views/share_links.py
import hashlib
...
from analytics.models import ShareLink
...
def share_links_management(request):
    ...
    if request.method == 'POST' and 'save_link' in request.POST:
        ...
        return redirect('analytics:share_links')
    ...
    return render(request, 'analytics/share_links.html', context)
