...
def analytics_consent_config():
    ...
    analytics-events.js as window.PAXALIA_CONSENT_CONFIG. Include this
    tag immediately before the analytics-events.js <script src="...">
    tag on your tracked pages — see the README's "Consent Mode"
    section. If omitted, analytics-events.js defaults to consent mode
