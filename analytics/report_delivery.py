...
logger = logging.getLogger('analytics.reporting')
...
def send_report_email(report, snapshot):
    ...
    analytics.reporting.compute_overview_snapshot(). Returns True/False
    ...
    html_body = render_to_string('analytics/email/report_digest.html', {
