...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('analytics', '0014_uptime_monitoring'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deployment', to='analytics.chartannotation')),
                ('site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deployments', to='analytics.site')),
            ],
            options={
