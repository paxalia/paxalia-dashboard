...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('paxalia', '0005_flip_anonymize_ip_default'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name='page_views', to='paxalia.site',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                related_name='events', to='paxalia.site',
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                related_name='csp_violations', to='paxalia.site',
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name='daily_stats', to='paxalia.site',
            ),
        ),
