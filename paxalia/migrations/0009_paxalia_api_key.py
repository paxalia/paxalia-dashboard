...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('paxalia', '0008_dashboard_access_permissions'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scope_read', models.BooleanField(default=False, help_text='Allows reading paxalia data via the read API.')),
                ...
                ('site', models.ForeignKey(
                    ...
                    related_name='api_keys', to='paxalia.site',
