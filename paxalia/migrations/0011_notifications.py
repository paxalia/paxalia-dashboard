...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('paxalia', '0010_reporting_sharing'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='paxalia.site')),
            ],
