    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uptime_monitors', to='paxalia.site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monitor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='checks', to='paxalia.uptimemonitor')),
            ],
            options={
                'ordering': ['-checked_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monitor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incidents', to='paxalia.uptimemonitor')),
            ],
            options={
