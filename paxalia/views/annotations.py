...
from paxalia.models import ChartAnnotation
...
def annotations_management(request):
    ...
    if request.method == 'POST' and 'save_annotation' in request.POST:
        ...
        return redirect('paxalia:annotations')
    ...
    return render(request, 'paxalia/annotations.html', context)
