...
from paxalia.conversions import goal_conversion, funnel_dropoff
from paxalia.models import Goal, Funnel, FunnelStep, PageView
...
def funnels_management(request):
    ...
    if request.method == 'POST' and 'save_funnel' in request.POST:
        ...
        return redirect('paxalia:funnels')
