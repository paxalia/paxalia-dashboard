...
def server_overview(request):
    ...
    return render(request, 'paxalia/server_overview.html', context)
...
def server_cpu(request):
    ...
    return render(request, 'paxalia/server_cpu.html', context)
...
def server_memory(request):
    ...
    return render(request, 'paxalia/server_memory.html', context)
...
def server_disk(request):
    ...
    return render(request, 'paxalia/server_disk.html', context)
...
def server_network(request):
    ...
    return render(request, 'paxalia/server_network.html', context)
...
def server_services(request):
    ...
    return render(request, 'paxalia/server_services.html', context)
...
def server_processes(request):
    ...
    return render(request, 'paxalia/server_processes.html', context)


@require_section_permission('server')
def server_slow_queries(request):
    from paxalia.models import SlowQuery
    ...
    return render(request, 'paxalia/server_slow_queries.html', context)


@require_section_permission('server')
def server_queues(request):
    from paxalia.queue_monitor import get_queue_stats
    ...
    return render(request, 'paxalia/server_queues.html', context)


@require_section_permission('server')
def server_deployments(request):
    from paxalia.models import Deployment
    ...
    return render(request, 'paxalia/server_deployments.html', context)
