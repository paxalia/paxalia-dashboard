...
from paxalia.models import PageView, DailySiteStats, AnalyticsEvent
...
class Command(BaseCommand):
    help = 'Generate 30 days of fake paxalia, events, and optional billing data'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Seeded 30 days of paxalia data'))